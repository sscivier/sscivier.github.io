...
\renewcommand{\labelenumi}{[\arabic{enumi}]}
\begin{etaremune}[itemsep=4pt, start=5]

\item \textbf{S.A. Scivier}, P. Koelemeijer, A.M. Mag, and T. Nissen-Meyer, ``From uncertain velocity models to ensemble-based ground motion simulations,'' \textit{Oral presentation}, European Geosciences Union General Assembly, Vienna, Austria (May 2026). Session SM2.4 - Physics-Based Earthquake Modelling and Engineering.
...
\teachentry{Workshop Demonstrator}{03/2026}{Advanced Python for Environmental Science}{NERC Essential Scientific Computing for Environmental Scientists (ESCES); Department of Earth Sciences, University of Oxford}{Oxford, UK}{%
Supported delivery of a workshop on scalable scientific Python for environmental data, covering parallelisation (NumPy, Numba, Dask), high-performance computing workflows, geospatial data plotting (Cartopy), handling large datasets with Xarray, and parallel-friendly storage formats.
Provided hands-on technical support during practical exercises, assisting MSc, PhD, and postdoctoral researchers with debugging and implementing parallel and data-intensive workflows.
Helped reinforce best practices in scientific computing, including performance optimisation and reproducible research using modern Python tools.
}

\teachentry{Workshop Co-Leader}{11/2025}{Earthquake Early Warning and AI: Open Problems and Future Directions}{Oxford Intelligent Earth CDT, University of Oxford}{Oxford, UK}{%
Led a group reading and discussion exercise for first-year PhD students exploring gaps and future research directions in AI-based earthquake early warning (EEW).
Facilitated critical analysis of state-of-the-art EEW methods, engaging students in brainstorming and proposing solutions to open problems.
The discussion focused on three research challenges: physics-informed learning for data-sparse regions, rigorous uncertainty quantification, and spatially continuous predictions beyond monitoring networks.
}

\teachentry{Workshop Co-Leader}{11/2024}{Gaussian Processes for Probabilistic Earthquake Ground Motion Prediction}{Oxford Intelligent Earth CDT, University of Oxford}{Oxford, UK}{%
...
\textbf{Geophysics:} Finite-difference methods, seismic wave propagation, geospatial data analysis \\
\textbf{Tools:} Git, GitHub, LaTeX, VS Code \\
\textbf{Methods:} Probabilistic modelling, machine learning, numerical methods, open-source software development, workflow automation
\end{minipage}\par
\vspace{0.5em}
